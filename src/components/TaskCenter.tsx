...
export function TaskCenter() {
  ...
  return (
    <div className="max-w-md mx-auto min-h-screen bg-white flex flex-col">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden">
              ...
              <div className="px-4 pb-4 pt-2 flex gap-2">
                <button className="flex-1 rounded-lg bg-gray-50 py-3 flex items-center justify-center gap-2">
                  {/* <QrCode className="w-4 h-4 text-orange-500" /> */}
                  <Scan className="w-4 h-4 text-orange-500" />
                  <span className="text-sm">当面扫码</span>
                </button>
                <button className="flex-1 rounded-lg bg-gray-50 py-3 flex items-center justify-center gap-2 relative">
      ...
      {
        showSignInModal && (  
           <div className="fixed inset-0 max-w-md mx-auto flex items-center justify-center z-50 px-4">
           <div className="absolute inset-0 bg-black/50" onClick={() => setShowSignInModal(false)} />
